    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Meta Title" value="{{old('pro_description_seo', isset($product->pro_description_seo)?$product->pro_description_seo:'')}}" name="pro_description_seo">
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <input type="number" placeholder="Giá sản phẩm" class="form-control" name="pro_price" id="" value="{{old('pro_price', isset($product->pro_price)?$product->pro_price:'')}}" >
            ...
            <div class="form-group">
                <label for="pro_sale">% Khyến mãi:</label>
                <input type="number" placeholder="% giảm giá" class="form-control" name="pro_sale" value="0" id="">
            </div>
            <div class="form-group">
                <img id="out_img" src="{{asset('img/no_image.png')}}" alt="" style="width:100% ; height:300px">
            </div>
            <div class="form-group">
